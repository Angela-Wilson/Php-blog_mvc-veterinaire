...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 11, 2021 at 08:18 PM
...
CREATE TABLE IF NOT EXISTS `oiseau` (
  ...
  `idRace` int NOT NULL,
  PRIMARY KEY (`idAnimal`),
  KEY `fk_oiseau_race_oiseau1_idx` (`idRace`) USING BTREE
...
DROP TABLE IF EXISTS `race_oiseau`;
CREATE TABLE IF NOT EXISTS `race_oiseau` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
