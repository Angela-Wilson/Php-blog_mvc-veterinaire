...
class Blog
{
  ...
  public function getById($iId)
  {
    ...
    (SELECT idAnimal, nom FROM chat As A INNER JOIN race_chat AS B ON A.idRace = B.id UNION SELECT idAnimal, nom FROM oiseau As A INNER JOIN race_oiseau AS B ON A.idRace = B.id UNION SELECT idAnimal, nom FROM chien As A INNER JOIN race_chien AS B ON A.idRace = B.id order by idAnimal) AS t2 ON t1.id = t2.idAnimal WHERE t1.id = :animalId LIMIT 1 ');
  ...
  public function getAll()
  {
    ...
    (SELECT idAnimal, nom FROM chat As A INNER JOIN race_chat AS B ON A.idRace = B.id 
    UNION 
    SELECT idAnimal, nom FROM oiseau As A INNER JOIN race_oiseau AS B ON A.idRace = B.id UNION SELECT idAnimal, nom FROM chien As A INNER JOIN race_chien AS B ON A.idRace = B.id order by idAnimal) 
